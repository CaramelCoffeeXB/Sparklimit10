...
import com.mouse.common.beans.City
import com.mouse.common.utils.FileConfiUtils
import com.mouse.produce.mock.utils.{RanOpt, RandomOptions}
...
object RealtimeADS {
  ...
  def generateMockData(): Array[String] = {
    ...
    val CityRandomOpt = RandomOptions(RanOpt(City(1,"北京","华北"),30),
      RanOpt(City(1,"上海","华东"),30),
      RanOpt(City(1,"广州","华南"),10),
      RanOpt(City(1,"深圳","华南"),20),
      RanOpt(City(1,"天津","华北"),10) ,
      RanOpt(City(1,"武汉","华中"),10),
      RanOpt(City(1,"沈阳","东北"),20))
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = FileConfiUtils.apply("config.properties").confi

package com.mouse.produce.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.mouse.common.beans.{City, Product, User, UserVisitInfo}
import com.mouse.common.utils.{FileConfiUtils, Get_UUID}
import com.mouse.produce.mock.utils.{RanOpt, RandomDate, RandomNum, RandomOptions}
...
/**
  * 将模拟数据插入hbase中
  */
object Install_data_to_Hbase {
  val userNum = 100; //用户数量
  val productNum = 100 //商品数量
  val sessionNum = 50000 //session数量
  ...
  val professionRandomOpt = RandomOptions(RanOpt("学生狗", 4), RanOpt("搬砖的", 3), RanOpt("搬砖的宿敌", 2), RanOpt("老师", 1))
  ...
  def main(args: Array[String]): Unit = {
    ...
    insertHive(sparkSession, "user_visit_info", userVisitActionDF)
  ...
  def mockUserAction() = {
    val rows = new ListBuffer[UserVisitInfo]()
    ...
    for (i <- 1 to sessionNum) {
      ...
      val sessionId = Get_UUID.mk_UUID
      var isQuit = false
      ...
      while (!isQuit) {
        ...
        if (action == "quit") {
          ...
          val userVisitAction = UserVisitInfo(
            actionDateString,
            userId.toLong,
            sessionId,
  ...
  def mockProductInfo() = {
    val rows = new ListBuffer[Product]()
  ...
  def mockCityInfo() = {
    List(City(1L, "北京", "华北"), City(2L, "上海", "华东"),
      City(3L, "深圳", "华南"), City(4L, "广州", "华南"),
      City(5L, "武汉", "华中"), City(6L, "南京", "华东"),
      City(7L, "天津", "华北"), City(8L, "成都", "西南"),
      City(9L, "哈尔滨", "东北"), City(10L, "大连", "东北"),
      City(11L, "沈阳", "东北"), City(12L, "西安", "西北"),
      City(13L, "长沙", "华中"), City(14L, "重庆", "西南"),
      City(15L, "济南", "华东"), City(16L, "石家庄", "华北"),
      City(17L, "银川", "西北"), City(18L, "杭州", "华东"),
      City(19L, "保定", "华北"), City(20L, "福州", "华南"),
      City(21L, "贵阳", "西南"), City(22L, "青岛", "华东"),
      City(23L, "苏州", "华东"), City(24L, "郑州", "华北"),
      City(25L, "无锡", "华东"), City(26L, "厦门", "华南")
    )
  }
}
